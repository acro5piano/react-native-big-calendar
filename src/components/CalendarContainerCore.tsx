...
export interface CalendarContainerCoreProps<T extends ICalendarEventBase> {
  /**
...
function _CalendarContainerCore<T extends ICalendarEventBase>({
  events,
  height,
  hourRowHeight,
  ampm = false,
...
export const CalendarContainerCore = typedMemo(_CalendarContainerCore)
