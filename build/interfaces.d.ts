...
export declare type EventCellStyle<T extends ICalendarEventBase> =
  | ViewStyle
  | ((event: T) => ViewStyle)
export declare type CalendarCellStyle =
  | ViewStyle
  | ((date?: Date, hourRowIndex?: number) => ViewStyle)
export declare type CalendarCellTextStyle =
  | TextStyle
  | ((date?: Date, hourRowIndex?: number) => TextStyle)
...
export declare type EventRenderer<T extends ICalendarEventBase> = (
  event: T,
  touchableOpacityProps: CalendarTouchableOpacityProps,
) => JSX.Element
export declare type HeaderRenderer<T extends ICalendarEventBase> = React.ComponentType<
