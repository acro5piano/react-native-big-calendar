...
function getEventSpanningInfo(event, date, dayOfTheWeek, calendarWidth) {
    ...
    var eventDuration = dayjs__default['default'].duration(dayjs__default['default'](event.end).diff(dayjs__default['default'](event.start))).days() + 1;
    var eventDaysLeft = dayjs__default['default'].duration(dayjs__default['default'](event.end).diff(date)).days() + 1;
...
var _HourGuideColumn = function (_a) {
    ...
    var theme = useTheme();
    var textStyle = React__namespace.useMemo(function () { return ({ color: theme.palette.gray[900], fontSize: theme.typography.xs.fontSize }); }, [theme]);
    var evenCellBg = theme.palette.evenCellBg;
    var oddCellBg = theme.palette.oddCellBg;
    return (React__namespace.createElement(reactNative.View, { style: { height: cellHeight, backgroundColor: isPair(index) ? evenCellBg : oddCellBg } },
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null,
        ...
        React__namespace.createElement(reactNative.ScrollView, __assign({ style: [
            ...
            React__namespace.createElement(reactNative.View, __assign({ style: [u['flex-1'], theme.isRTL ? u['flex-row-reverse'] : u['flex-row']] }, (reactNative.Platform.OS === 'web' ? panResponder.panHandlers : {})),
                React__namespace.createElement(reactNative.View, { style: [u['z-20'], u['w-50']] }, hours.map(function (hour, index) { return (React__namespace.createElement(HourGuideColumn, { key: hour, cellHeight: cellHeight, hour: hour, ampm: ampm, index: index, hourStyle: hourStyle })); })),
                dateRange.map(function (date) { return (React__namespace.createElement(reactNative.View, { style: [u['flex-1'], u['overflow-hidden']], key: date.toString() },
                    hours.map(function (hour, index) { return (React__namespace.createElement(HourGuideCell, { key: hour, cellHeight: cellHeight, date: date, hour: hour, onPress: _onPressCell, index: index })); }),
                    events
                        .filter(function (_a) {
                        var start = _a.start;
                    ...
                    isToday(date) && !hideNowIndicator && (React__namespace.createElement(reactNative.View, { style: [
                        ...
                        React__namespace.createElement(reactNative.View, { style: { width: 3, height: 3, borderRadius: 1.5, backgroundColor: theme.palette.nowIndicator } }),
                        React__namespace.createElement(reactNative.View, { style: [
                                styles.nowIndicator,
                                { top: "".concat(getRelativeTopInDay(now), "%") },
                                { backgroundColor: theme.palette.nowIndicator },
...
function _CalendarEventForMonthView(_a) {
    ...
    var theme = useTheme();
    var _b = React__namespace.useMemo(function () { return getEventSpanningInfo(event, date, dayOfTheWeek, calendarWidth); }, [date, dayOfTheWeek, event, calendarWidth]), eventWidth = _b.eventWidth, isMultipleDays = _b.isMultipleDays, isMultipleDaysStart = _b.isMultipleDaysStart, eventWeekDuration = _b.eventWeekDuration;
    var touchableOpacityProps = useCalendarTouchableOpacityProps({
        event: event,
        eventCellStyle: eventCellStyle,
        onPressEvent: onPressEvent,
...
function _CalendarBodyForMonthView(_a) {
    ...
    return (React__namespace.createElement(reactNative.View, __assign({ style: [
        ...
        React__namespace.createElement(reactNative.View, { style: [__assign({}, ((date === null || date === void 0 ? void 0 : date.format('YYYY-MM-DD')) === now.format('YYYY-MM-DD')) ? { textAlign: 'center', backgroundColor: theme.palette.primary.main, width: 22, height: 18, borderRadius: 16, marginLeft: 15, justifyContent: 'center', alignItems: 'center' } : { textAlign: 'center', alignSelf: 'center' })] },
            React__namespace.createElement(reactNative.Text, { style: [
                    { textAlign: 'center' },
                    theme.typography.sm,
                    {
        ...
        mode !== 'day' && dateRange.map(function (date) {
            ...
            return (React__namespace.createElement(reactNative.TouchableOpacity, { style: [u['flex-1'], u['pt-2']], onPress: function () { return _onPressHeader(date.toDate()); }, disabled: onPressDateHeader === undefined, key: date.toString() },
                React__namespace.createElement(reactNative.View, { style: [
                    ...
                    mode !== 'day' && React__namespace.createElement(reactNative.View, { style: objHasContent(dayHeaderStyle)
                            ? dayHeaderStyle
                            : shouldHighlight
                                ? [
                                    primaryBg,
...
function _CalendarContainer(_a) {
    ...
    var _0 = React__default['default'].useState(dayjs__default['default'](date)), targetDate = _0[0], setTargetDate = _0[1];
    React__default['default'].useEffect(function () {
        if (date) {
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        ...
        React__default['default'].createElement(CalendarBody, __assign({}, commonProps, { style: bodyContainerStyle, containerHeight: height, events: daytimeEvents, eventCellStyle: eventCellStyle, hideNowIndicator: hideNowIndicator, overlapOffset: overlapOffset, scrollOffsetMinutes: scrollOffsetMinutes, ampm: ampm, showTime: showTime, onPressCell: onPressCell, onPressEvent: onPressEvent, onSwipeHorizontal: onSwipeHorizontal, renderEvent: renderEvent, headerComponent: headerComponent, headerComponentStyle: headerComponentStyle, hourStyle: hourStyle }))));
}
