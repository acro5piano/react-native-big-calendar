...
function usePanResponder(_a) {
  ...
  var _b = React__default.useState(false),
    panHandled = _b[0],
    setPanHandled = _b[1]
  var panResponder = React__default.useMemo(
    function () {
...
function useCalendarTouchableOpacityProps(_a) {
  ...
  var getEventStyle = React__default.useMemo(
    function () {
  ...
  var plainJsEvent = React__default.useMemo(
    function () {
  ...
  var _onPress = React__default.useCallback(
    function () {
...
var _HourGuideCell = function (_a) {
  ...
  var theme = useTheme()
  var getCalendarCellStyle = React.useMemo(
    function () {
...
function _CalendarBody(_a) {
  ...
  var _renderMappedEvent = React.useCallback(
        ...
        dateRange.map(function (date) {
          return React.createElement(
            ...
            events
              ...
              .map(function (event) {
                return __assign(__assign({}, event), { start: dayjs(event.end).startOf('day') })
              })
              .map(_renderMappedEvent),
            events
              .filter(function (_a) {
...
function _CalendarBodyForMonthView(_a) {
  ...
  var getCalendarCellTextStyle = React.useMemo(
    function () {
  ...
  var sortedEvents = React.useCallback(
    function (day) {
...
function _CalendarHeader(_a) {
  ...
  var _onPressHeader = React.useCallback(
    function (date) {
      onPressDateHeader && onPressDateHeader(date)
    },
    [onPressDateHeader],
  )
  var _onPressEvent = React.useCallback(
    function (event) {
...
function _CalendarContainer(_a) {
  ...
  var _5 = React__default.useState(dayjs(date)),
    targetDate = _5[0],
    setTargetDate = _5[1]
  React__default.useEffect(
    function () {
  ...
  var allDayEvents = React__default.useMemo(
    function () {
  ...
  var daytimeEvents = React__default.useMemo(
    function () {
      return events.filter(function (event) {
        return !isAllDayEvent(event.start, event.end)
      })
  ...
  var dateRange = React__default.useMemo(
    function () {
      switch (mode) {
        case 'month':
  ...
  var cellHeight = React__default.useMemo(
    function () {
  ...
  var theme = useTheme()
  var onSwipeHorizontal = React__default.useCallback(
    function (direction) {
      if (!swipeEnabled) {
        return
      }
