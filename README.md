...
export const AgendaWithCustomRenderer: React.FC = () => {
  return (
    <Calendar
      events={[
        {
          title: 'Custom Component',
          start: new Date(2021, 3, 20, 12, 0, 0),
          end: new Date(2021, 3, 20, 15, 30, 0),
          eventRenderer,
        },
      ]}
      height={1200}
